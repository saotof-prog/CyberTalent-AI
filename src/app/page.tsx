...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#080c14] text-white overflow-x-hidden">
      ...
      {/* NAVBAR */}
      <nav className="relative z-10 flex items-center justify-between px-8 py-5 border-b border-[#00c896]/10 bg-[#080c14]/90 backdrop-blur sticky top-0">
      ...
      <section className="relative z-10 flex flex-col items-center justify-center text-center px-6 py-32">
        ...
        <div className="flex items-center gap-4">
          <Link href="/sign-up" className="font-mono text-sm px-8 py-4 bg-[#00c896] text-black font-bold rounded-xl hover:bg-[#00ff9d] transition">
            Créer mon profil gratuitement →
          </Link>
          <Link href="/recruiter/dashboard" className="font-mono text-sm px-8 py-4 border border-[#ff4060]/30 text-[#ff4060] rounded-xl hover:bg-[#ff4060]/10 transition">
            Espace recruteur 🎯
          </Link>
        </div>

        {/* STATS */}
        <div className="flex items-center gap-12 mt-16 pt-12 border-t border-[#00c896]/10">
          <div className="text-center">
            <div className="font-mono text-3xl font-bold text-[#00c896]">100%</div>
            <div className="font-mono text-xs text-gray-500 mt-1">Compétences vérifiées</div>
          </div>
          <div className="text-center">
            <div className="font-mono text-3xl font-bold text-white">IA</div>
            <div className="font-mono text-xs text-gray-500 mt-1">Scoring automatique</div>
          </div>
          <div className="text-center">
            <div className="font-mono text-3xl font-bold text-[#ff4060]">0</div>
      ...
      <section className="relative z-10 px-8 py-20 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="font-mono text-3xl font-bold text-white">Prouve tes vraies compétences</h2>
        </div>
      ...
      {/* FEATURES RECRUTEUR */}
      <section className="relative z-10 px-8 py-20 bg-[#0d1520]/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="font-mono text-xs text-[#ff4060] mb-4"> / POUR LES RECRUTEURS</div>
            <h2 className="font-mono text-3xl font-bold text-white">Trouve le bon talent en secondes</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { icon: "⚡", title: "Recherche IA naturelle", desc: 'Tape "Pentester senior OSCP avec expérience cloud" et l\'IA trouve les candidats qui matchent vraiment.' },
      ...
      <section className="relative z-10 px-8 py-20 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="font-mono text-xs text-[#00c896] mb-4">/ COMMENT ÇA MARCHE</div>
          <h2 className="font-mono text-3xl font-bold text-white">3 étapes simples</h2>
        </div>
      ...
      <section className="relative z-10 px-8 py-24 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="font-mono text-4xl font-bold text-white mb-6">Prêt à prouver ton niveau ?</h2>
          <p className="font-mono text-sm text-gray-400 mb-10">
            Rejoins CyberTalent AI et laisse tes vraies compétences parler pour toi.
          </p>
      ...
      <footer className="relative z-10 border-t border-[#00c896]/10 px-8 py-8 text-center">
        <div className="font-mono text-xs text-gray-600">
          © Mouhamed A Dia 2026 CyberTalent AI · Propulsé par Google Gemini · Fait avec ❤️ pour la communauté cyber africaine
        </div>
      </footer>
