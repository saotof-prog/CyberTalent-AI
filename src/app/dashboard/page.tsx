...
export default async function DashboardPage() {
  ...
  const score = profile.cyberScore;
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-[#0d1520] border border-[#00c896]/20 rounded-xl p-6">
            ...
            <div className="font-mono text-6xl font-bold text-[#00c896]">{score}</div>
          ...
          <div className="bg-[#0d1520] border border-[#00c896]/20 rounded-xl p-6">
            ...
            <a href="#add-lab" className="mt-4 w-full font-mono text-xs py-2 px-4 border border-[#00c896]/30 text-[#00c896] rounded-lg hover:bg-[#00c896]/10 transition block text-center">
              + Ajouter
            </a>
          </div>
        </div>
        ...
        {/* PROFIL INFO */}
        <div className="bg-[#0d1520] border border-[#00c896]/20 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div>
              ...
              <div className="font-mono text-sm text-white">{profile.firstName} {profile.lastName}</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="font-mono text-sm text-[#00c896]">
                {profile.githubUsername ? "@" + profile.githubUsername : "—"}
              </div>
            </div>
            <div>
              <div className="font-mono text-xs text-gray-400 mb-1">DISPONIBILITÉ</div>
              <div className={"font-mono text-sm " + (profile.isAvailable ? "text-[#00c896]" : "text-[#ff4060]")}>
          ...
          {profile.bio && (
            <div className="mt-4 pt-4 border-t border-[#00c896]/10">
              ...
              <div className="font-mono text-sm text-gray-300">{profile.bio}</div>
            </div>
          )}
        </div>

        {/* SKILLS — SkillsManager remplace l'ancien bloc statique */}
        <div className="mb-8">
          <SkillsManager />
        </div>
