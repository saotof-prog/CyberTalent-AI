...
export default function AdminCertVerifyActions({
  certId,
}: {
  certId: string;
  certName: string;
  ...
  async function handleApprove() {
    setLoading("approve");
    try {
      const res = await fetch(`/api/admin/certifications/${certId}/verify`, {
        method: "POST",
        ...
        <div className="space-y-3">
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Pourquoi cette certification est-elle rejetée ?"
